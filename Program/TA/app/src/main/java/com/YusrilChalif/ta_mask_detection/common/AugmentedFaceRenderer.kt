...
import com.YusrilChalif.ta_mask_detection.common.rendering.ShaderUtil.loadGLShader
...
class AugmentedFaceRenderer {
    ...
    fun createOnGlThread(
        ...
        val vertexShader: Int = loadGLShader(TAG, context, GLES20.GL_VERTEX_SHADER,
            VERTEX_SHADER_NAME
        )
        val fragmentShader: Int = loadGLShader(TAG, context, GLES20.GL_FRAGMENT_SHADER,
